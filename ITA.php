...
<body>
	<div class="container">
        ...
        <label class="col-xs-12"><div class="col-xs-3">Session :</div><input type="text" name="Session" class="col-xs-9"></label>
        <label class="col-xs-12"><div class="col-xs-3">Attendance :</div><input type="text" name="Attendance" class="col-xs-9"></label>
